...
- In Rotation Estimation folder take a look at this file TestMySOFTForComparisonPurposes.m
- The folder 3D_SphericalPolarFT_Registration should have many helpful functions and useful scripts, much of it will try to add other folders from https://github.com/syedalamabbas/2D_3D_PolarFourierTransform or MEX_SOFT project that is included.
