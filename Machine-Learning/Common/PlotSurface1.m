...
% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
function [fighndl]= PlotSurface1(vertices,faces)
id=1;
% Colors for plotting
red=[1.0 0.0 0.0];  
% red=[0.6 0.0 0.0];  
...
% edgecolor = [0.2 0.2 0.2]; % grey ?
edgecolor = [.2 .2 .2]; % dark red ?
% edgecolor = [.9 .9 .9]; % dark red ?

%na=[ 'Object: ' filename  ]; %'   Thetha_x=' num2str(theta.x) '   Theta_y='  num2str(theta.y) '  Theta_z='  num2str(theta.z)];
%tit=['Object: ' filename '   Thetha_x=' num2str(theta.x) '   Theta_y='  num2str(theta.y) '  Theta_z='  num2str(theta.z)];
fighndl=[];
...
%     id
    ...
    % Plot surface
    [fighndl]=plotsurf1(faces,vertices,facecolor(id,:),edgecolor,fighndl);  
    xlabel('x')
ylabel('y')
zlabel('z')
