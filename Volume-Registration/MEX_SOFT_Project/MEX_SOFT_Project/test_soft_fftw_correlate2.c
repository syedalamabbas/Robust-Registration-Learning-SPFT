...
//*/
//
///*****************************************This File is designed to serve a testing file for the operation of correlation between two functions*/
///** Simply make following changes to the project file for this to run using main function ****/
///******************** 1.  Change VC++ directories --> Configuration type from .dll to .exe, change also the target type extension */
///******************** 2.  Change linker system to console***********************************/
//
//
//
...
///*Debugging Command Line Input arguments ===   randomS2sigA_bw8.dat randomS2sig_bw8.dat 8 8 7 */
//
///*New Command Line from the output of rotation , now estimation, ==   myRotated.dat randomS2sig_bw8.dat 8 8 7 */ 
//
//
//#include <math.h>
//#include <stdio.h>
