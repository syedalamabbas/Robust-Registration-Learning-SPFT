%function [ node_xyz, triangle_node ] = ply_to_tri_surface ( ply_file_name )
function [ vertices, faces ] = ply_to_tri_surface ( ply_file_name )
%*****************************************************************************80
%
...
vertices=node_xyz';
faces= triangle_node';
save('3Ddataset\venusv_obj', 'vertices','faces');
