...
validMinimize = {'point','plane','lma_point'};
    ...
    if arg.Extrapolation
        ...
        if k>2 && theta(k+1) < 10 && theta(k) < 10
            ...
            if dv ~= 0
                ...
                [S, mindist] = match_kDtree(q,pt,kdOBJ);
...
function [match mindist] = match_kDtree(S, p, kdOBJ)
...
[U,S,V] = svd(N); % singular value decomposition
