function SpharmMatUtilDisplayObjsPS(confs, objs, cpath)
...
for i = 1:numSbj
    ...
    if exist('bim','var')
       ...
       % f1=plotsurfaceT(vertices,faces,confs.name,confs.theta,confs.theta_r);
       % saveas (f1 ,['..\3Ddataset\datatest\test1\pngR\' na  num2str(1) '.png'] ); 
    else
      %  f1=plotsurfaceT(vertices,faces,confs.name,confs.theta,confs.theta_r);
      %  saveas (f1 ,['..\3Ddataset\datatest\test1\pngR\' na  num2str(1) '.png'] ); 
